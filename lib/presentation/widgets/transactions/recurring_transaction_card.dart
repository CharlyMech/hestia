          ...
          child: Row(
            ...
            children: [
              Container(
                ...
                child: Repeat(width: 18, height: 18, color: accent),
              ),
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      transaction.categoryName ?? transaction.type.name,
              ...
              Text(
                '${isExp ? '-' : '+'}${transaction.amount.abs().toStringAsFixed(2)}',
