...
/// as the first sliver (above the pinned app bar) for pull-to-refresh; when
/// omitted the page is non-refreshable. RULE: a page that sets [onRefresh] MUST
/// also drive [isLoading] so the load shows the Skeletonizer shimmer.
              ...
              SliverAppBar(
                ...
                leading: Padding(
                  ...
                  child: AnimatedButton(
                    ...
                    child: NavArrowLeft(width: 22, height: 22, color: fg),
                  ),
                ),
                leadingWidth: 56,
