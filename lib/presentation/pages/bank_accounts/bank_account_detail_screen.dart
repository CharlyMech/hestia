...
class _BankAccountDetailScreenState extends State<BankAccountDetailScreen> {
  ...
  /// Opens the transaction sheet with the bank account pre-filled (bug #6).
  Future<void> _openNewTransactionSheet() async {
    final source = _source;
    if (_householdId == null || _userId == null || source == null) return;
  ...
  Widget build(BuildContext context) {
            ...
            children: [
              ...
              Container(
                ...
                child: SpendDonut(
                  ...
                  border: border,
                  surface: surface,
                  palette: theme.categoryTints.map(hexToColor).toList(),
                ),
              ),
              const SizedBox(height: 12),
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      NavArrowRight(width: 14, height: 14, color: muted),
                    ],
                  ),
                ),
              ),
                ...
                Column(
                  ...
                  children: [
                    for (final g in _goals)
                      GoalProgressCard(
                        goal: g,
                        color: g.color != null ? hexToColor(g.color!) : accent,
                        surface: surface,
                        border: border,
                        fg: fg,
                        muted: muted,
    ...
    return CupertinoPushedRouteShell(
      ...
      titleText: barTitle,
      onRefresh: _load,
      trailing: (_source == null || _notFound)
          ? null
          : Padding(
              ...
              child: AnimatedButton(
                ...
                onTap: _openNewTransactionSheet,
